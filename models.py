...
class WebsiteSetting(db.Model):
    ...
    address = db.Column(db.String(255), default='Nature Unisex Salon, Austin Town / Neelasandra, Bengaluru, Karnataka 560047, India')
    ...
    instagram_url = db.Column(db.String(255), default='https://instagram.com/natureunisexsalon')
    facebook_url = db.Column(db.String(255), default='https://facebook.com/natureunisexsalon')
    opening_hours_weekdays = db.Column(db.String(100), default='Mon - Sat: 9:00 AM - 9:00 PM')
    opening_hours_weekends = db.Column(db.String(100), default='Sun: 10:00 AM - 8:00 PM')
